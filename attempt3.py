...
class MainWindow(QMainWindow):
    ...
    # Draw a box around the zoomed-in area in the small view
        painter = QPainter(self.small_view_label.pixmap())
        painter.setPen(QPen((Qt.red), 3))
        zoomed_in_rect = QRect(10, 10, 100, 75)  # Adjust the coordinates and size as needed
        painter.drawRect(zoomed_in_rect)
        painter.end()
